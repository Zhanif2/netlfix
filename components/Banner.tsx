...
function Banner({ netflixOriginals }: Props) {
  ...
  console.log(movie);
  return (
    <div className="flex flex-col space-y-2 py-20 md:space-y-6 md:py-32 lg:space-y-8 lg:py-40
    lg:pb-12">
      ...
      <h1 className="text-2xl font-bold md:text-4xl lg:text-7xl line-clamp-">
